...
class Sales extends MY_Controller
{
	...
	function getSales($warehouse_id = NULL)
    {
        ...
        <ul class="dropdown-menu pull-right" role="menu">
			...
			(($this->Owner || $this->Admin) ? '<li>'.$down_payment.'</li>' : ($this->GP['sales-payments'] ? '<li>'.$down_payment.'</li>' : '')).
			(($this->Owner || $this->Admin) ? '<li>'.$sale_edit_down_payment.'</li>' : ($this->GP['sales-payments'] ? '<li>'.$sale_edit_down_payment.'</li>' : '')).
			 '<li>' . $installment . '</li>'
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    $biller = $this->site->getAllBillerData();

                    $this->excel->getActiveSheet()->mergeCells('A1:K1');
                    $this->excel->getActiveSheet()->setCellValue('A1','ឡៅឡឹង');
                    $this->excel->getActiveSheet()->mergeCells('A2:K2');
                    $this->excel->getActiveSheet()->setCellValue('A2', $biller->address);
                    $this->excel->getActiveSheet()->mergeCells('A3:K3');
                    $this->excel->getActiveSheet()->setCellValue('A3', 'Tel: '.$biller->phone .' | Email: '. $biller->email);

					$this->excel->getActiveSheet()->mergeCells('A4:K4');
                    $this->excel->getActiveSheet()->setCellValue('A4','របាយការណ៍អតិថិជនជំពាក់');
                    $this->excel->getActiveSheet()->setCellValue('A5','Customer Name ');
					$this->excel->getActiveSheet()->mergeCells('B5:C5');
                    $this->excel->getActiveSheet()->setCellValue('B5', ': '.$customer->code .' | '. $customer->name);
					$this->excel->getActiveSheet()->setCellValue('A6','Tel ');
                    $this->excel->getActiveSheet()->mergeCells('B6:C6');
                    $this->excel->getActiveSheet()->setCellValue('B6', ': '.$customer->phone);
                    $this->excel->getActiveSheet()->setCellValue('A7','Address ');
					$this->excel->getActiveSheet()->mergeCells('B7:C7');
                    $this->excel->getActiveSheet()->setCellValue('B7', ': '.$customer->address);

                    $this->excel->getActiveSheet()->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);


                    $this->excel->getActiveSheet()->getStyle('A1')->getFont()->setName('Khmer OS Content')->setSize(18);
                    $this->excel->getActiveSheet()->getStyle('A2')->getFont()->setName('Khmer OS Content')->setSize(14);
                    $this->excel->getActiveSheet()->getStyle('A3')->getFont()->setName('Khmer OS Content')->setSize(14);
                    $this->excel->getActiveSheet()->getStyle('A4')->getFont()->setName('Khmer OS Content')->setSize(16);
                    $this->excel->getActiveSheet()->getStyle('A5:K5')->getFont()->setName('Khmer OS Content')->setSize(12);
                    $this->excel->getActiveSheet()->getStyle('A6:K6')->getFont()->setName('Khmer OS Content')->setSize(12);
                    $this->excel->getActiveSheet()->getStyle('A7:K7')->getFont()->setName('Khmer OS Content')->setSize(12);
                    $this->excel->getActiveSheet()->getRowDimension(4)->setRowHeight(50);
                    $this->excel->getActiveSheet()->getStyle('A4:K4')->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border:: BORDER_MEDIUM);
                    ...
                    $this->excel->getActiveSheet()->SetCellValue('B8', lang('due_date'));
                    $this->excel->getActiveSheet()->SetCellValue('C8', lang('reference_no'));
                    $this->excel->getActiveSheet()->SetCellValue('D8', lang('sale_status'));
                    $this->excel->getActiveSheet()->SetCellValue('E8', lang('grand_total'));
                    $this->excel->getActiveSheet()->SetCellValue('F8', lang('return'));
                    $this->excel->getActiveSheet()->SetCellValue('G8', lang('paid'));
                    $this->excel->getActiveSheet()->SetCellValue('H8', lang('deposit'));
                    $this->excel->getActiveSheet()->SetCellValue('I8', lang('discount'));
                    $this->excel->getActiveSheet()->SetCellValue('J8', lang('balance'));
                    $this->excel->getActiveSheet()->SetCellValue('K8', lang('payment_status'));
                    $this->excel->getActiveSheet()->getStyle('A8:K8')->getFont()->setName('Times New Roman')->setSize(
                        12);
                    $this->excel->getActiveSheet()->getRowDimension(8)->setRowHeight(30);
                    $this->excel->getActiveSheet()->getStyle('A8:K8')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);

                    $this->excel->getActiveSheet()->getStyle('A8:K8')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                    $styleArray = array(
                        'font'  => array(
                            'bold'  => true,
                    ...
                    $this->excel->getActiveSheet()->getStyle('A8:K8')->applyFromArray($styleArray);

                    if ($this->input->post('form_action') == 'export_pdf') {
                         $borderStyleForPDF = array(
                              'borders' => array(
                                  'allborders' => array(
                        ...
                        $this->excel->getDefaultStyle()->applyFromArray($borderStyleForPDF);
                    }
                    ...
                    foreach ($_POST['val'] as $id) {
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('D' . $row, $row_data->sale_status);
                        $this->excel->getActiveSheet()->SetCellValue('E' . $row, $this->erp->formatMoney($row_data->amount));
                        $this->excel->getActiveSheet()->SetCellValue('F' . $row, $this->erp->formatMoney($row_data->return_sale));
                        $this->excel->getActiveSheet()->SetCellValue('G' . $row, $this->erp->formatMoney($row_data->paid));
                        $this->excel->getActiveSheet()->SetCellValue('H' . $row, $this->erp->formatMoney($row_data->deposit));
                        $this->excel->getActiveSheet()->SetCellValue('I' . $row, $this->erp->formatMoney($row_data->discount));
                        $this->excel->getActiveSheet()->SetCellValue('J' . $row, $this->erp->formatMoney($row_data->balance));
                        $this->excel->getActiveSheet()->SetCellValue('K' . $row, $row_data->payment_status);

                        $this->excel->getActiveSheet()->getStyle('A' .$row . ':K' .$row)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
                        $this->excel->getActiveSheet()->getStyle('E' . $row . ':J' . $row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
                        ...
                        $this->excel->getActiveSheet()->getStyle('A'.$row.':K'.$row)->getFont()->setName('Khmer OS Content')->setSize(10);
					...
					$this->excel->getActiveSheet()->SetCellValue('E' . $row, $this->erp->formatMoney($total_amount));
					$this->excel->getActiveSheet()->SetCellValue('F' . $row, $this->erp->formatMoney($total_return_sale));
					$this->excel->getActiveSheet()->SetCellValue('G' . $row, $this->erp->formatMoney($total_paid));
					$this->excel->getActiveSheet()->SetCellValue('H' . $row, $this->erp->formatMoney($total_deposit));
					$this->excel->getActiveSheet()->SetCellValue('I' . $row, $this->erp->formatMoney($total_discount));
					$this->excel->getActiveSheet()->SetCellValue('J' . $row, $this->erp->formatMoney($total_balance));
                    $this->excel->getActiveSheet()->getStyle('A'.$row.':K'.$row)->getFont()->setName('Khmer OS Content')->setBold(true)->setSize(12);
                    $row++;
                    $this->excel->getActiveSheet()->mergeCells('B'.$row.':C'.$row);
                    $this->excel->getActiveSheet()->setCellValue('B'.$row,'រៀបចំដោយ');
                    $this->excel->getActiveSheet()->mergeCells('D'.$row.':F'.$row);
                    $this->excel->getActiveSheet()->setCellValue('D'.$row,'ត្រួតពិនិត្យដោយ');
                    $this->excel->getActiveSheet()->mergeCells('I'.$row.':J'.$row);
                    $this->excel->getActiveSheet()->setCellValue('I'.$row,'ទទួលស្គាល់ដោយ');

                    $this->excel->getActiveSheet()->getStyle('B'.$row.':J'.$row)->getFont()->setName('Khmer OS Content')->setBold(true)->setSize(12);
                    $this->excel->getActiveSheet()->getRowDimension($row)->setRowHeight(70);
                    $this->excel->getActiveSheet()->getStyle('B'.$row.':J'.$row)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);

                    $this->excel->getActiveSheet()->getStyle('B'.$row.':c'.$row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
                    $this->excel->getActiveSheet()->getStyle('D'.$row.':F'.$row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                    ...
                    if ($this->input->post('form_action') == 'export_pdf') {
                        ...
                        $this->excel->getActiveSheet()->getStyle("A" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("A" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("A" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("A" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("B" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("B" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("B" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("B" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("D" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("D" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("D" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("D" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("G" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("G" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("G" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("G" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("H" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("H" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("H" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("H" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("I" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("I" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("I" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("I" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("K" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("K" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("K" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                        $this->excel->getActiveSheet()->getStyle("K" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    ...
                    if ($this->input->post('form_action') == 'export_excel') {
						...
						$this->excel->getActiveSheet()->getStyle('E'.$new_row.':K'.$new_row)->applyFromArray($footer_style);
                        header('Content-Type: application/vnd.ms-excel');
                        header('Content-Disposition: attachment;filename="' . $filename . '.xls"');
                        header('Cache-Control: max-age=0');
                        $styleArray = array(
                        ...
                        $this->excel->getActiveSheet()->getStyle('A4:M4')->applyFromArray($styleArray);
						...
						$this->excel->getActiveSheet()->getStyle("A4:M4")->getFont()->setSize(12);
	...
	function save_edit_deliveries($id=null)
	{
		...
		for($i=0; $i<$rows; $i++) {
			...
			if($option_id[$i] != 0)
			{
				$old_qty = $delivery_item->quantity_received * $unit_qty->qty_unit;
			}else{
				$old_qty = $delivery_item->quantity_received;
			}
            ...
            for ($r = 0; $r < $i; $r++) {
                ...
                if (isset($item_code) && isset($real_unit_price) && isset($unit_price) && isset($item_quantity)) {
					...
					if($slaeid > 0 || $slaeid) {
						...
						$old_sqty = $sale_item->quantity_balance;
					}
	...
	function bill_reciept_form($id = NULL)
	{
		...
		//$this->erp->print_arrays($this->sales_model->getProductNewByID($payment->sale_id));
	...
	function add_payment_loan($data = NULL, $id = NULL, $paid_amount = NULL, $principle = NULL, $sale_id = NULL)
    {
        ...
        $this->erp->checkPermissions('payments', true);
        $this->load->helper('security');
        $this->form_validation->set_rules('paid', lang("amount"), 'required');
        $this->form_validation->set_rules('paid_by', lang("paid_by"), 'required');
        ...
        if ($this->form_validation->run() == true) {
			...
			$curr_paid 		= 0;
			$help 			= false;
			$reference      = $this->input->post('reference_no') ? $this->input->post('reference_no') : $this->site->getReference('sp', $biller_id);
			...
			for($i=0; $i<sizeof($arr_id)-1; $i++){
				...
				if($help) {
					...
					$this->sales_model->addLoanPayment($payments,$interest);
				}
			}
        ...
        if ($this->form_validation->run() == true) {
			...
			//$this->erp->print_arrays($loan_data->paid_amount);
	...
	function edit_down_payment($id=null)
	{
        ...
        if ($this->form_validation->run() == true) {
				...
				$join_lease	=  $this->sales_model->AddJoinLease($jl_data,$sale_id);
				$payment    =  $this->sales_model->addPayment($payment);
				$result     =  $this->sales_model->Addloans($loans,$sale_id,$biller_id,$frequency,$term,$depre_type,$princ_type,$down,$down_date,1);
				redirect("sales");
	...
	function changeLoanTerm($id) {
        ...
        $this->form_validation->set_rules('depreciation_term', lang("depreciation_term"), 'required');
        if ($this->form_validation->run() == true) {
        ...
        if ($this->form_validation->run() == true && $this->sales_model->updateLoanTerm($id, $loans)) {
			...
			//$this->erp->print_arrays( $this->sales_model->leftTerm($id));
	...
	function print_w_a5($id = NULL)
    {
        ...
        $this->data['warehouse'] = $this->site->getWarehouseByID($inv->warehouse_id);
        $this->data['inv'] = $inv;
		$rows = $this->sales_model->getInvoiceBydigital_id($id);
