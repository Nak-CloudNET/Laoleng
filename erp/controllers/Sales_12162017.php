        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
					...
					$this->excel->getActiveSheet()->setCellValue('A3','Tel : ');
					$this->excel->getActiveSheet()->mergeCells('B3:C3');
                    $this->excel->getActiveSheet()->setCellValue('B3', $customer->phone);
					
                    $this->excel->getActiveSheet()->SetCellValue('A4', lang('date'));
                    $this->excel->getActiveSheet()->SetCellValue('B4', lang('due_date'));
                    $this->excel->getActiveSheet()->SetCellValue('C4', lang('reference_no'));
                    $this->excel->getActiveSheet()->SetCellValue('D4', lang('project'));
                    $this->excel->getActiveSheet()->SetCellValue('E4', lang('customer'));
                    $this->excel->getActiveSheet()->SetCellValue('F4', lang('sale_status'));
                    $this->excel->getActiveSheet()->SetCellValue('G4', lang('grand_total'));
                    $this->excel->getActiveSheet()->SetCellValue('H4', lang('return'));
                    $this->excel->getActiveSheet()->SetCellValue('I4', lang('paid'));
                    $this->excel->getActiveSheet()->SetCellValue('J4', lang('deposit'));
                    $this->excel->getActiveSheet()->SetCellValue('K4', lang('discount'));
                    ...
                    if ($this->input->post('form_action') == 'export_pdf') {
						...
						$this->excel->getActiveSheet()->getStyle('A2:M2')->applyFromArray($style);
						$this->excel->getActiveSheet()->getStyle('A3:M3')->applyFromArray($style);
						$this->excel->getActiveSheet()->getStyle('A4:M4')->applyFromArray($header_style);
						$this->excel->getActiveSheet()->getStyle('A4:M4')->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
