...
class Purchases extends MY_Controller
{
	...
	public function getPurchases_nodiscount($warehouse_id = null)
    {
        $this->erp->checkPermissions('index',null,'purchases');
		if($warehouse_id){
	...
	public function received_kh($purchase_id = null)
    {
        ...
        $this->data['warehouse'] = $this->site->getWarehouseByID($inv->warehouse_id);
        $this->data['billers'] = $this->purchases_model->getAllBillers($inv->biller_id);$this->data['inv'] = $inv;
        $this->data['payments'] = $this->purchases_model->getPaymentsForPurchase($purchase_id);
        $this->data['created_by'] = $this->site->getUser($inv->created_by);
        $this->data['updated_by'] = $inv->updated_by ? $this->site->getUser($inv->updated_by) : null;
	...
	*********/
	...
	function getSupplierBalance_action($user_id){
        ...
        if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
            if ($_POST['val']) {
                ...
                $this->excel->getActiveSheet()->SetCellValue('A4', lang('របាយការណ៍ជំពាក់អ្នកផ្គត់ផ្គង់'));
                $this->excel->getActiveSheet()->setCellValue('A5','Supplier Name ');
                $this->excel->getActiveSheet()->mergeCells('B5:C5');
                $this->excel->getActiveSheet()->setCellValue('B5', ': '.$supplier->name);
                $this->excel->getActiveSheet()->setCellValue('A6','Tel ');
                $this->excel->getActiveSheet()->mergeCells('B6:C6');
                $this->excel->getActiveSheet()->setCellValue('B6', ': '.$supplier->phone);
                $this->excel->getActiveSheet()->setCellValue('A7','Address ');
                $this->excel->getActiveSheet()->mergeCells('B7:C7');
                $this->excel->getActiveSheet()->setCellValue('B7', ': '.$supplier->address);
                ...
                $this->excel->getActiveSheet()->getStyle('A5:I5')->getFont()->setName('Khmer OS Content')->setSize(12);
                $this->excel->getActiveSheet()->getStyle('A6:I6')->getFont()->setName('Khmer OS Content')->setSize(12);
                $this->excel->getActiveSheet()->getStyle('A7:I7')->getFont()->setName('Khmer OS Content')->setSize(12);
                $this->excel->getActiveSheet()->getRowDimension(4)->setRowHeight(50);
                $this->excel->getActiveSheet()->getStyle('A4:I4')->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border:: BORDER_MEDIUM);
                ...
                $this->excel->getActiveSheet()->SetCellValue('D8', lang('warehouse'));
                $this->excel->getActiveSheet()->SetCellValue('E8', lang('supplier'));
                $this->excel->getActiveSheet()->SetCellValue('F8', lang('grand_total'));
                $this->excel->getActiveSheet()->SetCellValue('G8', lang('paid'));
                $this->excel->getActiveSheet()->SetCellValue('H8', lang('balance'));
				$this->excel->getActiveSheet()->SetCellValue('I8', lang('payment_status'));

                $this->excel->getActiveSheet()->getStyle('A8:I8')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);

                $this->excel->getActiveSheet()->getStyle('A8:I8')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                $styleArray = array(
                    'font'  => array(
                        'bold'  => true,
                ...
                foreach ($_POST['val'] as $id) {
                        ...
                        foreach($supplier as $sup){ 
                            ...
                            $this->excel->getActiveSheet()->getStyle('A'.$row.':I'.$row)->getFont()->setName('Khmer OS Content')->setSize(10);
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('F' . $row, $this->erp->formatMoney($sum_grandtotal));
                            $this->excel->getActiveSheet()->SetCellValue('G' . $row, $this->erp->formatMoney($sum_paid));
                            $this->excel->getActiveSheet()->SetCellValue('H' . $row, $this->erp->formatMoney($sum_balance));
                            $this->excel->getActiveSheet()->getStyle('A'.$row.':I'.$row)->getFont()->setName('Khmer OS Content')->setSize(12);
							$this->excel->getActiveSheet()->getStyle('F'. $row.':H'.$row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
							$row++;
                            $this->excel->getActiveSheet()->mergeCells('A'.$row.':B'.$row);
                            $this->excel->getActiveSheet()->setCellValue('A'.$row,'រៀបចំដោយ');
                            ...
                            $this->excel->getActiveSheet()->setCellValue('H'.$row,'ទទួលស្គាល់ដោយ');

                            $this->excel->getActiveSheet()->getStyle('A'.$row.':I'.$row)->getFont()->setName('Khmer OS Content')->setBold(true)->setSize(12);
                            ...
                            $this->excel->getActiveSheet()->getStyle('D'.$row.':I'.$row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                ...
                if ($this->input->post('form_action') == 'export_pdf') {
                    ...
                    $this->excel->getActiveSheet()->getStyle("C" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    $this->excel->getActiveSheet()->getStyle("C" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    $this->excel->getActiveSheet()->getStyle("C" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    $this->excel->getActiveSheet()->getStyle("C" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    ...
                    $this->excel->getActiveSheet()->getStyle("F" . $row)->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    $this->excel->getActiveSheet()->getStyle("F" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    $this->excel->getActiveSheet()->getStyle("F" . $row)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                    $this->excel->getActiveSheet()->getStyle("F" . $row)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
                ...
                if ($this->input->post('form_action') == 'export_excel') {
                    ...
                    ob_clean();
					$this->excel->getActiveSheet()->getStyle('F'.$row. ':H'.$row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
					$this->excel->getActiveSheet()->getStyle('F'. $row.':H'.$row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
                    header('Content-Type: application/vnd.ms-excel');
                    header('Content-Disposition: attachment;filename="' . $filename . '.xls"');
                    header('Cache-Control: max-age=0');
	...
	function getViewSupplierBalance_nodiscount($pdf = NULL, $xls = NULL)
    {
			...
			if($type_exp=='po'){
				...
				for ($r = 0; $r < $i; $r++) {
					...
					if (isset($item_code) && isset($real_unit_cost) && isset($unit_cost) && isset($item_quantity) && isset($quantity_balance)) {
						...
						if($item_option != 0) {
							if($item_net_cost == $option_cost){
								$subtotal = ($item_net_cost * ( $quantity_received!=0?$quantity_received * $option_cost : $item_quantity*$option_cost));
							}else{
