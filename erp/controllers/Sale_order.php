...
class Sale_order extends MY_Controller
{
        ...
        if ($this->form_validation->run() == true)
        {
            ...
            for ($r = 0; $r < $i; $r++) {	
                ...
                if (isset($item_code) && isset($real_unit_price) && isset($unit_price) && isset($item_quantity)) {
                    ...
                    $item_net_price = $this->erp->formatDecimal($unit_price - $pr_discount);
	...
	function edit_down_payment($id=null){
        ...
        if ($this->form_validation->run() == true) {
				...
				$join_lease	=  $this->sale_order_model->AddJoinLease($jl_data,$sale_id,$jl_row);
				$result     =  $this->sale_order_model->Addloans($loans,$sale_id,$biller_id,$frequency,$term,$depre_type,$princ_type,$down,$down_date,1);
