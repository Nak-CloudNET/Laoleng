							...
							<div class="col-md-0">
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="loan_amount" type="text" id="loan_amount" value="<?= $this->erp->formatDecimal($inv->grand_total - (($inv->paid+$order_down->down_amount))); ?>" style="pointer-events:none" class="form-control loan_amount" placeholder="<?= lang('loan_amount') ?>"/>
									</div>
								</div>
							</div>
						</div>
