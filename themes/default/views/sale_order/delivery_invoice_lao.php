...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12">	
				<center>
					...
					<h3><strong><?= lang('ប័ណ្ណដឹកជញ្ជូន') ?></strong></h3>
				</center>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-6">
				<div class="row referno" style="padding-left: 330px;">
		...
		<div class="row" style="margin-bottom: 50px !important;">
			<div class="col-sm-3 col-xs-3">
				<p><strong><?= lang('អ្ន​ករៀបចំ') ?></strong></p>
			</div>
			<div class="col-sm-3 col-xs-3">
				<p><strong><?= lang('អ្នកផ្តល់សិទិ្ធ') ?></strong></p>
			</div>
			<div class="col-sm-3 col-xs-3">
				<p><strong><?= lang('អ្នកបើកបរ') ?></strong></p>
			</div>
			<div class="col-sm-3 col-xs-3">
				<p><strong><?= lang('អ្នកទទួល') ?></strong></p>
			</div>
		</div>
