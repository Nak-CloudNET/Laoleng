                ...
                <table class="table table-bordered table-striped table-condensed table-hover" style="margin-bottom: 0px;">
                    ...
                    <tbody>
						...
						<tr>
							...
							<td>
								<button type="button" class="btn bdarkGreen col-md-12" id="close_register" data-placement="bottom" data-html="true" href="<?= site_url('pos/close_register'.$this->session->userdata('user_id')) ?>" data-toggle="modal" data-target="#myModal"> <?= $pos_settings->close_register ?></button>
							</td>
						</tr>
						<tr>
