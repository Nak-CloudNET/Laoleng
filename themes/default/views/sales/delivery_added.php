											...
											<?php
												...
												foreach($delivery_items as $delivery){
													...
													echo   '<input type="hidden" value="'.$delivery['id'].'" name="delivery_id[]" id="delivery_id" style="width: 150px; height: 30px;text-align:center;">
															...
															<td>
																<input type="text" class="piece" value ="'.$this->erp->formatDecimal($delivery['piece']).'"name="piece[]" style="width: 150px; height: 30px;text-align:center;">
																<input type="hidden" class="cur_piece" value ="'.$this->erp->formatDecimal($delivery['piece']).'"name="cur_piece[]" style="width: 150px; height: 30px;text-align:center;">
															</td>
															<td>
