		...
		<div class="col-xs-12" style="width:810px !important;">
			...
			<div class="row">
				...
				<div class="col-sm-5 col-xs-5">
					<table style="font-size: 12px;margin-top:-20px;">
						<tr>
							<td style="width: 20%;">លេខរៀងបញ្ជារទិញ </br> So No.</td>
							<td style="width: 5%;">:</td>
							<td style="width: 30%;"><?= $sale_order->reference_no ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>រយះពេលប្រាក់</br>​Payment Term</td>
							<td>:</td>
							<td><?= $invs->due_date; ?></td>
			...
			<div id="footer" class="row" style="margin-top: 80px !important;">
				...
				<div class="col-lg-3 col-sm-3 col-xs-3">
					...
					<center>
						...
						<p style="margin-top:-10px;font-size:11px !important;">Delivery's Signature & Name</p>
					</center>
				</div>
			</div>
			<footer></footer>
