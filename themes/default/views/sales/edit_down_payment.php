							   ...
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="loan_amount" type="text" id="loan_amount" style="pointer-events:none"
											   class="form-control loan_amount" value="<?=$this->erp->formatDecimal($inv->grand_total - ($inv->paid+$order_down->down_amount)) ?>"
...
$( document ).ready(function() {	
	...
	var site = <?= json_encode(array('base_url' => base_url(), 'settings' => $Settings, 'dateFormats' => $dateFormats)) ?> 
		...
		$('change','#principle_type_1, #loan_amount,#down_date,#down_payment').on("change",function()
		{
			var option = $("#principle_type_1 option:selected").val();
			if(option!='none')
			{
