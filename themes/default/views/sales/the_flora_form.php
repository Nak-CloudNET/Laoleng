	...
	<div class='container'>
		<div class="col-lg-8 col-lg-offset-2">
			<div class='row text-center col-lg-12'>
				...
				<br>
				<h4 class="moul" >កិច្ចសន្យាបង់រម្លស់</h4>
			</div>
			...
			<div class='row col-lg-12 font-kh-bt'>
				...
				<ul style='list-style-type:none'>
					<li><b>២.១.</b>ក្នុងករណីដែលភាគី“ខ”មិនបានបង់ប្រាក់តាមកាលកំណត់ដូចដែលមានចែងក្នុងប្រការ១ខាងលើទេនោះភាគី“ខ”នឹង
						<div style="text-indent: 32px;">ត្រូវមានកាតព្វកិច្ចបង់ប្រាក់ពិន័យដូចខាងក្រោម :</div>
					</li>
					<li style="margin-left: 35px;">• ករណីយឺតយ៉ាវ <b>០៧ ដល់៣០ថ្ងៃ</b>ភាគី “ខ”ត្រូវបង់ប្រាក់ពិន័យឲ្យភាគី“ក” ចំនួន <b>៥%</b> 		(ប្រាំភាគរយ)ក្នុងមួយខែនៃ <div style="text-indent: 13px;">ទឹកប្រាក់ដែលត្រូវបង់ដោយគិតតាមចំនួនថ្ងៃដែលយឺត។</div>
					</li>
					<li>
						<b>២.២.</b>ករណីភាគី“ខ”ខកខានមិនបានបង់ប្រាក់តាមកាលកំណត់តាមឥណប្រតិទានរបស់ប្រាក់បង់រម្លស់មួយលើកឬច្រើន
						<div style="text-indent: 32px;">
							លើករួមជាមួយការប្រាក់និងប្រាក់ពិន័យតាមការកំណត់ក្នុងរយះពេល<b>៣១</b>ថ្ងៃកិច្ចសន្យានេះ នឹងត្រូវរំលាយ ជាស្វ័យ</div>
							<div style="text-indent: 32px;">ប្រវត្តិ។ក្នុងករណីនេះភាគី“ក”មានសិទ្ធគ្រប់គ្រាន់ទទួលយកប្រាក់ទាំងអស់ដែលភាគី“ខ”បានបង់និងមានសិទ្ធិគ្រប់គ្រាន់</div>
							<div style="text-indent: 32px;">ប្រើប្រាស់អាស្រ័យផលនិងចាត់ចែងអចលនទ្រព្យនេះ។</div>
				...
				<div style="text-indent: 32px;"></div>
					...
					<ul style='list-style-type:none'>
						<li><b>៣.១.</b>ភាគី“ខ”មានសិទ្ធបង់រម្លស់ប្រាក់ដើម    អោយភាគី“ក”ខ្លះឬបង់ទាំងអស់មុនកាលកំណត់     នៃកិច្ចព្រមព្រៀងនេះ
						ដោយពុំ​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​<div style="text-indent: 32px;">មានការផាកពិន័យអ្វីឡើយហើយទឹកប្រាក់ដែលត្រូវបង់ប្រចាំខែនឹងមានការប្រែប្រួលទៅតាមតារាងបង់ប្រាក់</div>
						<div style="text-indent: 32px;">ដែលភាគី“ក”ចេញជូនជាថ្មី។</div>
						</li>
						<li>
							<b>៣.២.</b>បន្ទាប់ពីភាគី “ខ” បានបង់ប្រាក់ថ្លៃទិញផ្ទះគ្រប់ចំនួននោះភាគី “ក”នឹងរៀបចំឯកសារផ្ទេរកម្មសិទ្ធ(ប្លង់រឹង)ជូនទៅភាគី
							<div style="text-indent: 32px;">“ខ”ដែលភាគី“ខ”ជាអ្នកចំណាយលើសេវាកម្មរត់ការឯកសារពន្ធប្រថាប់ត្រា និងសេវាផ្សេងៗទៀត ។</div>
						</li>
						<li>
							<b>៣.៣.</b>ភាគី“ខ”នឹងមិនអនុញ្ញាតិឲ្យមានការដាក់បញ្ចាំឬការធានាផលប្រយោជន៍លើផ្ទះដែលទិញនេះឡើយលុះត្រាតែភាគី
							<div style="text-indent: 32px;">“ខ”បានបង់ប្រាក់ចប់សព្វគ្រប់ឬមានការយល់ព្រមជាលាយលក្ខអក្សរពីភាគី“ក”ជាមុន។</div>
						</li>
					</ul>
					...
					<ul style='list-style-type:none'>
						...
						<li>
							...
							<div style="text-indent: 32px;">ហត្ថលេខានេះតទៅ។</div>
						</li>
						<li>
							<b>៤.៣.</b>កិច្ចព្រមព្រៀងនេះធ្វើឡើងជាភាសាខ្មែរចំនួន ០២ ច្បាប់មានតម្លៃស្មើគ្នា ដែលត្រូវតម្កល់ទុកនៅភាគី“ខ” ចំនួនមួយ 
							<div style="text-indent: 32px;">ច្បាប់និង ភាគី “ក” ចំនួនមួយច្បាប់ ។</div> 
						</li>
						<li>
							<b>៤.៤.</b>ដោយបានអាននិងយល់ច្បាស់អំពីខ្លឹមសារទាំងមូលនៃកិច្ចសន្យានេះភាគីទាំងពីរអនុវត្តតាមកិច្ចសន្យានេះដោយផ្តិត
							<div style="text-indent: 32px;">ស្នាមមេដៃនៅចំពោះមុខសាក្សីដូចខាងក្រោម។</div>
						</li>
					</ul>
				</div>
				<div class="row col-lg-12 font-kh-bt">
