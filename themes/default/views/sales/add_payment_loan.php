			...
			<div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <th style="width:15%;"><?= $this->lang->line("paid"); ?></th>
                                ...
                                <div class="paid">
                                    <div class="form-group">
                                        ...
                                        <input name="paid" type="text" id="paid"
                                               value=""
                                               class="pa form-control kb-pad paid" />
                                    </div>
                                </div>
                            </div>
							<div class="col-sm-6">
                                <div class="balance">
                                    <div class="form-group">
                                        ...
                                        <input name="balance" type="text" id="balance"
                                               value="0"
                                               class="pa form-control kb-pad balance" readonly />
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
		...
		{
			var paid           = $("#paid").val()-0;
			var total_payment  = $("#total_payment").val()-0;
			var discount       = $("#discount").val()-0;
			var t_paid	       = (total_payment)-(discount+paid);
			 
		    if((discount+paid)>total_payment)
			{
			   $("#discount,#paid").val(0);
			   $("#balance").val(total_payment);
			}else{
			   $("#balance").val(formatDecimal(t_paid));
			}
		});
