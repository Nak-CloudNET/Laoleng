				...
				<table style="border:1px solid black;width:100%;">
					...
					?>
						<tr style="height:35px;">
							<th style="border:1px solid black;width:255px;text-align:center;"><?php echo $row->name; ?></th>
							<th style="border:1px solid black;width:100px;text-align:center;"><?php echo $this->erp->formatDecimal($row->quantity); ?></th>
							<th style="border:1px solid black;width:100px;"><?php echo $this->erp->formatMoney($row->price); ?></th>
							<th style="border:1px solid black;width:100px;"><?php echo $this->erp->formatMoney($row->price * $row->quantity); ?></th>
