        ...
        <div class="col-lg-12">
            ...
            <div class="row padding10" style="margin-top: -20px !important">
                <div class="col-xs-5" id="customer" style="float: left;font-size:14px; margin-top: -30px !important">
                    <table id="customer-table" style="width:400px; font-size: 14px !important">
                ...
                <div class="col-xs-5"  style="float: right;font-size:14px; margin-top: -30px !important; font-size: 13px !important">
                    <table>
                        <tr>
                            <td>
            ...
            <div class="-table-responsive">
                <table class="table table-bordered table-striped" style="width: 100%;">
                    <thead  style="font-size: 13px;">
						<tr>
							<th><?= lang("ល.រ"); ?><br /><span style="font-size: 13px">No</span></th>
                            <th style="width: 80px !important"><?= lang("code_kh"); ?><br><span style="font-size: 13px"><?= lang("code");  ?></span></th> 
                            <th style="width: 350px !important"><?= lang("description_kh"); ?><br><span style="font-size: 13px"><?= lang("descript");  ?></span></th> 
                            <th><?= lang("unit_kh"); ?><br><span style="font-size: 13px"><?= lang("uom");  ?></span></th> 
                            <th><?= lang("number_kh2"); ?><br><span style="font-size: 13px"><?= lang("piece");  ?></span></th> 
                            <th><?= lang("length_piecs_kh"); ?><br><span style="font-size: 13px"><?= lang("length_piecs");  ?></span></th>
                            <th><?= lang("qty_kh"); ?><br><span style="font-size: 13px"><?= lang("qty");  ?></span></th> 
							<?php if($Owner || $Admin || $GP['sales-price']){ ?>
								<th style="width: 100px !important"><?= lang("unit_price_kh"); ?><br><span style="font-size: 13px"><?= lang("unit_price");  ?></span></th>
							<?php }?>
							<th><?= lang("បញ្ចុះតម្លៃ"); ?><br><span style="font-size: 13px"><?= lang("Discount");  ?></span></th>
                            <th style="width: 120px !important"><?= lang("total_kh"); ?><br><span style="font-size: 13px"><?= lang("total_capital");  ?></span></th> 
						</tr>
                    </thead>
                    <tbody>
                        <?php $r = 1; $row2 = 1;
                                    ...
                                    <?php
										if ($Settings->product_discount && $inv->product_discount != 0) {
											 if (strpos($row->discount , '%')){
												echo  ($row->discount != 0 ? $row->discount : '');
											} else{
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($row->total); ?></td>
                        </tr>
						...
						<?php if($row->order_tax != 0){ ?>
							<tr>
								<td colspan="2" style="text-align:right; font-weight:bold;"><?= lang("បញ្ចុះតម្លៃ"); ?>
								</td>
								<td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($row->order_tax); ?></td>
							</tr>
						<?php } ?>
						<?php if($row->shipping != 0){ ?>
							<tr>
								<td colspan="2" style="text-align:right; font-weight:bold;"><?= lang("ថ្លៃដឹក"); ?>
								</td>
								<td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($row->shipping); ?></td>
							</tr>
						<?php } ?>
                        <tr>
                            <td colspan="2" style="text-align:right; font-weight:bold;"><?= lang("totalpaid_kh"); ?>
                            </td>
                            <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($row->grand_total); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($row->grand_total-$inv->paid); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
