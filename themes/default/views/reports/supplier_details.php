                ...
                <div class="table-responsive">
                    <table id="PRData" class="table table-bordered table-hover table-striped table-condensed">
                        ...
                        <tbody>
							...
							$this->db->select('erp_companies.name as sup_name');
							$this->db->join('erp_companies', 'erp_companies.id = erp_purchases.supplier_id', 'left');
								...
								foreach($suppliers as $row){
									if($row->supplier_id){
										if($row->qty){
											?>
											<tr>
												<td colspan="9" style="background:#F0F8FF;"><b><?=$row->sup_name;?></b></td>
											</tr>
											<?php
